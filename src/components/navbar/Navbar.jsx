...
const Navbar = () => {
  ...
  const navItems = [
    { name: 'Food Redistribution', icon: <Leaf className="w-5 h-5" />, to: '/food-redistribution' },
    { name: 'Donate Items', icon: <Heart className="w-5 h-5" />, to: '/donate-items' },
    { name: 'About Food Waste', icon: <Recycle className="w-5 h-5" />, to: '/about-food-waste' },
  ];
